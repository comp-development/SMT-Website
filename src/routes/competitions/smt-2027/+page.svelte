<script>
  ...
  const scheduleData = [
    ['Event', 'Time', 'Students', 'Students', 'Students', 'Students', 'Parents/Coaches'],
    ...
    [
      ...
      'Set Tournament',
      'Estimathon',
      'Guest Speaker / Integration Bee Finals',
    ],
    [
      "<font style='font-size: 150%'>Saturday Tournament</font><br>4/18<br><i style='font-size: 80%'>Tournament Day</i>",
      '6:00 PM',
...
<br /><br />
<Heading
  text="Stanford Math Tournament 2027"
  size={4}
...
<div class="section-wrapper">
  <PanelBox>
    <div style="padding: 10px;">
      <p>
        <strong>DATE:</strong> April 10-11, 2027 <br />
      ...
      <div style="display: flex; gap: 16px; justify-content: center; align-items: center; margin: 10px 0;">
        ...
        <!-- <HeaderButton
          ...
          href="/competitions/smt-2027-online"
          isSmall
        />
      </div> -->
      ...
      <i
        ...
        to you, we encourage you to participate in <Link
          url="/competitions/smt-2027-online"
          text="SMT Online"
        /> instead.
      </i> <br />
      <br />
...
<div class="section-wrapper">
  <PanelBox>
    <div style="padding: 10px;">
      <p>
        SMT 2027 will be inviting <b>800 students</b> (~130-160 teams) from
        ...
        <a href="/competitions/smt-2027-online">online tournament</a>.
      </p>

      <h4>Schools</h4>
      <p>
        Students are highly encouraged to participate in SMT 2027 as part of
      ...
      <h4>Individuals</h4>
      <p>
        If you are not applying as part of a team to SMT 2027 in-person, you may apply
      ...
      <p>
        <i
          >These criteria only apply for SMT 2027 in-person, not for SMT 2027
